    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form action="{{ route('aset-lahan.update', $item->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select name="irigasi" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                                    <option value="0" {{ old('irigasi', $item->irigasi)==0 ? 'selected' : '' }}>Tidak</option>
                                    <option value="1" {{ old('irigasi', $item->irigasi)==1 ? 'selected' : '' }}>Ya</option>
                                </select>
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="notes" rows="3" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">{{ old('notes', $item->notes) }}</textarea>
                            </div>
